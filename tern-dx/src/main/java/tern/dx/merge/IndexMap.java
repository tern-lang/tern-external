...
package tern.dx.merge;

import static tern.dex.EncodedValueReader.ENCODED_ANNOTATION;
import static tern.dex.EncodedValueReader.ENCODED_ARRAY;
import static tern.dex.EncodedValueReader.ENCODED_BOOLEAN;
import static tern.dex.EncodedValueReader.ENCODED_BYTE;
import static tern.dex.EncodedValueReader.ENCODED_CHAR;
import static tern.dex.EncodedValueReader.ENCODED_DOUBLE;
import static tern.dex.EncodedValueReader.ENCODED_ENUM;
import static tern.dex.EncodedValueReader.ENCODED_FIELD;
import static tern.dex.EncodedValueReader.ENCODED_FLOAT;
import static tern.dex.EncodedValueReader.ENCODED_INT;
import static tern.dex.EncodedValueReader.ENCODED_LONG;
import static tern.dex.EncodedValueReader.ENCODED_METHOD;
import static tern.dex.EncodedValueReader.ENCODED_NULL;
import static tern.dex.EncodedValueReader.ENCODED_SHORT;
import static tern.dex.EncodedValueReader.ENCODED_STRING;
import static tern.dex.EncodedValueReader.ENCODED_TYPE;

import java.util.HashMap;

import tern.dex.Annotation;
import tern.dex.ClassDef;
import tern.dex.Dex;
import tern.dex.DexException;
import tern.dex.EncodedValue;
import tern.dex.EncodedValueCodec;
import tern.dex.EncodedValueReader;
import tern.dex.FieldId;
import tern.dex.Leb128;
import tern.dex.MethodId;
import tern.dex.ProtoId;
import tern.dex.TableOfContents;
import tern.dex.TypeList;
import tern.dex.util.ByteOutput;
import tern.dx.util.ByteArrayAnnotatedOutput;
