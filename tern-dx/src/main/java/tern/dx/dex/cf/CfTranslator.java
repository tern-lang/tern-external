...
package tern.dx.dex.cf;

import tern.dex.util.ExceptionWithContext;
import tern.dx.cf.code.ConcreteMethod;
import tern.dx.cf.code.Ropper;
import tern.dx.cf.direct.DirectClassFile;
import tern.dx.cf.iface.Field;
import tern.dx.cf.iface.FieldList;
import tern.dx.cf.iface.Method;
import tern.dx.cf.iface.MethodList;
import tern.dx.dex.DexOptions;
import tern.dx.dex.code.DalvCode;
import tern.dx.dex.code.PositionList;
import tern.dx.dex.code.RopTranslator;
import tern.dx.dex.file.ClassDefItem;
import tern.dx.dex.file.DexFile;
import tern.dx.dex.file.EncodedField;
import tern.dx.dex.file.EncodedMethod;
import tern.dx.dex.file.FieldIdsSection;
import tern.dx.dex.file.MethodIdsSection;
...
import tern.dx.rop.code.DexTranslationAdvice;
import tern.dx.rop.code.LocalVariableExtractor;
import tern.dx.rop.code.LocalVariableInfo;
import tern.dx.rop.code.RopMethod;
import tern.dx.rop.code.TranslationAdvice;
import tern.dx.rop.cst.Constant;
import tern.dx.rop.cst.ConstantPool;
import tern.dx.rop.cst.CstBaseMethodRef;
import tern.dx.rop.cst.CstBoolean;
import tern.dx.rop.cst.CstByte;
import tern.dx.rop.cst.CstChar;
import tern.dx.rop.cst.CstEnumRef;
import tern.dx.rop.cst.CstFieldRef;
import tern.dx.rop.cst.CstInteger;
import tern.dx.rop.cst.CstInterfaceMethodRef;
import tern.dx.rop.cst.CstMethodRef;
import tern.dx.rop.cst.CstShort;
import tern.dx.rop.cst.CstString;
import tern.dx.rop.cst.CstType;
import tern.dx.rop.cst.TypedConstant;
import tern.dx.rop.type.Type;
import tern.dx.rop.type.TypeList;
import tern.dx.ssa.Optimizer;
