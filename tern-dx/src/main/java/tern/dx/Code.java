...
import static tern.dx.rop.code.Rop.BRANCH_GOTO;
import static tern.dx.rop.code.Rop.BRANCH_NONE;
import static tern.dx.rop.code.Rop.BRANCH_RETURN;
import static tern.dx.rop.type.Type.BT_BYTE;
import static tern.dx.rop.type.Type.BT_CHAR;
import static tern.dx.rop.type.Type.BT_INT;
import static tern.dx.rop.type.Type.BT_SHORT;
...
public final class Code {
   ...
   public <D, V> void iput(FieldId<D, V> fieldId, Local<? extends D> instance, Local<? extends V> source) {
    ...
    private Rop getCastRop(tern.dx.rop.type.Type sourceType,
            tern.dx.rop.type.Type targetType) {
