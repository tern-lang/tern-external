...
import tern.dx.util.MutabilityControl;

/**
 * Container for local variable information for a particular {@link
 * tern.dx.ssa.SsaMethod}.
 * Stolen from {@link tern.dx.rop.code.LocalVariableInfo}.
 */
public class LocalVariableInfo         extends MutabilityControl {
    ...
    /**
     * {@code non-null;} {@link tern.dx.rop.code.RegisterSpecSet} to use when indicating a block
     ...
     * {@link tern.dx.rop.type.TypeBearer} (such as a constant value).
     *
