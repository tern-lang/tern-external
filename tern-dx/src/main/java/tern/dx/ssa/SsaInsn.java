...
public abstract class SsaInsn implements ToHuman, Cloneable {
    ...
    /**
     * Like {@link tern.dx.rop.code.Insn getResult()}.
     *
    ...
    /**
     * Like {@link tern.dx.rop.code.Insn getSources()}.
     *
     ...
     *
     * @see tern.dx.rop.code.Insn#getLocalAssignment()
     *
