...
package org.ternlang.dx.cf.cst;

import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_Class;
import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_Double;
import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_Fieldref;
import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_Float;
import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_Integer;
import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_InterfaceMethodref;
import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_InvokeDynamic;
import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_Long;
import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_MethodHandle;
import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_MethodType;
import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_Methodref;
import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_NameAndType;
import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_String;
import static org.ternlang.dx.cf.cst.ConstantTags.CONSTANT_Utf8;

import java.util.BitSet;

import org.ternlang.dx.cf.iface.ParseException;
import org.ternlang.dx.cf.iface.ParseObserver;
import org.ternlang.dx.rop.cst.Constant;
import org.ternlang.dx.rop.cst.CstDouble;
import org.ternlang.dx.rop.cst.CstFieldRef;
import org.ternlang.dx.rop.cst.CstFloat;
import org.ternlang.dx.rop.cst.CstInteger;
import org.ternlang.dx.rop.cst.CstInterfaceMethodRef;
import org.ternlang.dx.rop.cst.CstLong;
import org.ternlang.dx.rop.cst.CstMethodRef;
import org.ternlang.dx.rop.cst.CstNat;
import org.ternlang.dx.rop.cst.CstString;
import org.ternlang.dx.rop.cst.CstType;
import org.ternlang.dx.rop.cst.StdConstantPool;
