...
import org.ternlang.dx.rop.code.BasicBlockList;
import org.ternlang.dx.rop.code.Insn;
import org.ternlang.dx.rop.code.PlainCstInsn;
import org.ternlang.dx.rop.code.PlainInsn;
...
import org.ternlang.dx.rop.code.ThrowingCstInsn;
import org.ternlang.dx.rop.code.ThrowingInsn;
import org.ternlang.dx.rop.cst.CstInteger;
import org.ternlang.dx.rop.type.StdTypeList;

import static org.ternlang.dx.rop.code.Rop.BRANCH_GOTO;
import static org.ternlang.dx.rop.code.Rop.BRANCH_NONE;
import static org.ternlang.dx.rop.code.Rop.BRANCH_RETURN;
import static org.ternlang.dx.rop.type.Type.BT_BYTE;
import static org.ternlang.dx.rop.type.Type.BT_CHAR;
...
public final class Code {
   ...
   public <D, V> void iput(FieldId<D, V> fieldId, Local<? extends D> instance, Local<? extends V> source) {
    ...
    private Rop getCastRop(org.ternlang.dx.rop.type.Type sourceType,
            org.ternlang.dx.rop.type.Type targetType) {
