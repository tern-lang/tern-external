...
package org.ternlang.dx.merge;

import static org.ternlang.dex.EncodedValueReader.ENCODED_ANNOTATION;
import static org.ternlang.dex.EncodedValueReader.ENCODED_ARRAY;
import static org.ternlang.dex.EncodedValueReader.ENCODED_BOOLEAN;
import static org.ternlang.dex.EncodedValueReader.ENCODED_BYTE;
import static org.ternlang.dex.EncodedValueReader.ENCODED_CHAR;
import static org.ternlang.dex.EncodedValueReader.ENCODED_DOUBLE;
import static org.ternlang.dex.EncodedValueReader.ENCODED_ENUM;
import static org.ternlang.dex.EncodedValueReader.ENCODED_FIELD;
import static org.ternlang.dex.EncodedValueReader.ENCODED_FLOAT;
import static org.ternlang.dex.EncodedValueReader.ENCODED_INT;
import static org.ternlang.dex.EncodedValueReader.ENCODED_LONG;
import static org.ternlang.dex.EncodedValueReader.ENCODED_METHOD;
import static org.ternlang.dex.EncodedValueReader.ENCODED_NULL;
import static org.ternlang.dex.EncodedValueReader.ENCODED_SHORT;
import static org.ternlang.dex.EncodedValueReader.ENCODED_STRING;
import static org.ternlang.dex.EncodedValueReader.ENCODED_TYPE;

import java.util.HashMap;

import org.ternlang.dex.Annotation;
import org.ternlang.dex.ClassDef;
import org.ternlang.dex.Dex;
import org.ternlang.dex.DexException;
import org.ternlang.dex.EncodedValue;
import org.ternlang.dex.EncodedValueCodec;
import org.ternlang.dex.EncodedValueReader;
import org.ternlang.dex.FieldId;
import org.ternlang.dex.Leb128;
import org.ternlang.dex.MethodId;
