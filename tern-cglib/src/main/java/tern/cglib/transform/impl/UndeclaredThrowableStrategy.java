...
import tern.cglib.core.ClassGenerator;
import tern.cglib.core.DefaultGeneratorStrategy;
import tern.cglib.core.GeneratorStrategy;
import tern.cglib.core.TypeUtils;
import tern.cglib.transform.ClassTransformer;
import tern.cglib.transform.MethodFilter;
import tern.cglib.transform.MethodFilterTransformer;
import tern.cglib.transform.TransformingClassGenerator;

/**
 * A {@link GeneratorStrategy} suitable for use with {@link tern.cglib.Enhancer} which
