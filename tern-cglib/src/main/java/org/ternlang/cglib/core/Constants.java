 ...
 */
public interface Constants extends org.ternlang.asm.Opcodes {
    ...
    public static final Type TYPE_SIGNATURE = TypeUtils.parseType("org.ternlang.cglib.core.Signature");
