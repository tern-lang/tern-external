...
public class TestTransformingLoader extends org.ternlang.cglib.CodeGenTestCase {
    ...
    private static final ClassFilter TEST_FILTER = new ClassFilter() {
        public boolean accept(String name) {
            ...
            return name.startsWith("org.ternlang.cglib.");
        }
    };
    ...
    public void testAddStatic() throws Exception {
        Method m = ReflectUtils.findMethod("org.ternlang.cglib.transform.impl.TestTransformingLoader.initStatic(Class)");
