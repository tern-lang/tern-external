...
import org.ternlang.cglib.transform.impl.FieldProvider;
import org.ternlang.cglib.transform.impl.FieldProviderTransformer;
import org.ternlang.cglib.transform.impl.InterceptFieldCallback;
import org.ternlang.cglib.transform.impl.InterceptFieldEnabled;
...
public class TransformDemo {
   ...
   public static class Filter implements InterceptFieldFilter{
        ...
        public boolean acceptRead(org.ternlang.asm.Type owner, String name) {
                  return true;
        }
        
        public boolean acceptWrite(org.ternlang.asm.Type owner, String name) {
                  return true;
        }
