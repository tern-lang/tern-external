...
import org.ternlang.cglib.CodeGenTestCase;
import org.ternlang.cglib.core.AbstractClassGenerator;
import org.ternlang.cglib.core.DefaultNamingPolicy;
import org.ternlang.cglib.core.NamingPolicy;
import org.ternlang.cglib.core.Predicate;
import org.ternlang.cglib.core.ReflectUtils;
import org.ternlang.cglib.proxy.Callback;
import org.ternlang.cglib.proxy.CallbackFilter;
import org.ternlang.cglib.proxy.CallbackHelper;
import org.ternlang.cglib.proxy.Enhancer;
import org.ternlang.cglib.proxy.Factory;
import org.ternlang.cglib.proxy.FixedValue;
        ...
        ClassLoader custom = new ClassLoader(this.getClass().getClassLoader()) {
            ...
            public Class<?> loadClass(String name) throws ClassNotFoundException {
                if (EA.class.getName().equals(name)) {
                    InputStream classStream = this.getClass().getResourceAsStream("/org/ternlang/cglib/proxy/EA.class");
                    byte[] classBytes;
                    try {
  ...
  public void testCast()throws Throwable{
   ...
   public void testABC() throws Throwable{
    ...
    public void testBadNamingPolicyStillReservesNames() throws Throwable {
      ...
      e.setNamingPolicy(new NamingPolicy() {      
        public String getClassName(String prefix, String source, Object key, Predicate names) {
          return "org.ternlang.cglib.empty.Object$$ByDerby$$123";
        }
      });
    ...
    public void testNamingPolicyThatReturnsConstantNames() throws Throwable {
      Enhancer e = new Enhancer();
      final String desiredClassName = "org.ternlang.cglib.empty.Object$$42";
      e.setCallback(NoOp.INSTANCE);
      e.setClassLoader(new ClassLoader(this.getClass().getClassLoader()){});
      e.setNamingPolicy(new NamingPolicy() {
        public String getClassName(String prefix, String source, Object key, Predicate names) {
