...
import tern.asm.ClassWriter;
import tern.asm.MethodVisitor;
import tern.asm.Opcodes;
import tern.cglib.CodeGenTestCase;
import tern.cglib.core.AbstractClassGenerator;
import tern.cglib.core.DefaultNamingPolicy;
import tern.cglib.core.NamingPolicy;
import tern.cglib.core.Predicate;
import tern.cglib.core.ReflectUtils;
import tern.cglib.proxy.Callback;
import tern.cglib.proxy.CallbackFilter;
import tern.cglib.proxy.CallbackHelper;
import tern.cglib.proxy.Enhancer;
import tern.cglib.proxy.Factory;
import tern.cglib.proxy.FixedValue;
import tern.cglib.proxy.InvocationHandler;
import tern.cglib.proxy.MethodInterceptor;
import tern.cglib.proxy.MethodProxy;
import tern.cglib.proxy.NoOp;
import tern.cglib.reflect.FastClass;
        ...
        ClassLoader custom = new ClassLoader(this.getClass().getClassLoader()) {
            ...
            public Class<?> loadClass(String name) throws ClassNotFoundException {
                if (EA.class.getName().equals(name)) {
                    InputStream classStream = this.getClass().getResourceAsStream("/tern/cglib/proxy/EA.class");
                    byte[] classBytes;
                    try {
  ...
  public void testCast()throws Throwable{
   ...
   public void testABC() throws Throwable{
    ...
    public void testBadNamingPolicyStillReservesNames() throws Throwable {
      ...
      e.setNamingPolicy(new NamingPolicy() {      
        public String getClassName(String prefix, String source, Object key, Predicate names) {
          return "tern.cglib.empty.Object$$ByDerby$$123";
        }
      });
    ...
    public void testNamingPolicyThatReturnsConstantNames() throws Throwable {
      Enhancer e = new Enhancer();
      final String desiredClassName = "tern.cglib.empty.Object$$42";
      e.setCallback(NoOp.INSTANCE);
      e.setClassLoader(new ClassLoader(this.getClass().getClassLoader()){});
      e.setNamingPolicy(new NamingPolicy() {
        public String getClassName(String prefix, String source, Object key, Predicate names) {
