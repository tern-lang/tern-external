...
import tern.cglib.beans.*;
import tern.cglib.core.Constants;
import tern.cglib.core.ReflectUtils;
import tern.cglib.transform.*;
import tern.cglib.transform.impl.AddPropertyTransformer;
import tern.cglib.transform.impl.AddStaticInitTransformer;
import tern.cglib.transform.impl.FieldProviderTransformer;
import tern.cglib.transform.impl.InterceptFieldFilter;
import tern.cglib.transform.impl.InterceptFieldTransformer;

/**
 * @version $Id: TestTransformingLoader.java,v 1.6 2006/03/05 02:43:17 herbyderby Exp $
 */
public class TestTransformingLoader extends tern.cglib.CodeGenTestCase {

    private static final ClassFilter TEST_FILTER = new ClassFilter() {
        public boolean accept(String name) {
            System.err.println("Loading " + name);
            return name.startsWith("tern.cglib.");
        }
    };
    ...
    public void testAddStatic() throws Exception {
        Method m = ReflectUtils.findMethod("tern.cglib.transform.impl.TestTransformingLoader.initStatic(Class)");
