...
import tern.cglib.core.*;
import tern.cglib.transform.*;
import tern.cglib.transform.impl.AddDelegateTransformer;
import tern.cglib.transform.impl.AddStaticInitTransformer;
import tern.cglib.transform.impl.FieldProvider;
import tern.cglib.transform.impl.FieldProviderTransformer;
import tern.cglib.transform.impl.InterceptFieldCallback;
import tern.cglib.transform.impl.InterceptFieldEnabled;
...
public class TransformDemo {
   ...
   public static class Filter implements InterceptFieldFilter{
        ...
        public boolean acceptRead(tern.asm.Type owner, String name) {
                  return true;
        }
        
        public boolean acceptWrite(tern.asm.Type owner, String name) {
                  return true;
        }
