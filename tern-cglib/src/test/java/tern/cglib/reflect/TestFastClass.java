...
import tern.cglib.reflect.FastConstructor;
import tern.cglib.reflect.FastMethod;

import junit.framework.Test;
import junit.framework.TestSuite;

public class TestFastClass extends tern.cglib.CodeGenTestCase {
    ...
    public static class Child extends tern.cglib.reflect.sub.Parent { }
    ...
    public void testComplex() throws Throwable {
        ...
        assertEquals("fc.getName()", "tern.cglib.reflect.MemberSwitchBean", fc.getName());
        ...
        assertEquals("fc1.toString()", "public tern.cglib.reflect.MemberSwitchBean()", fc1.toString());
